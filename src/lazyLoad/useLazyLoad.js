...
const useLazyLoad = ({ triggerRef, onGrabData, updateTheCountryData }) => {
  ...
  useEffect(() => {
    if (triggerRef.current) {
      ...
      const observer = new IntersectionObserver(onIntersect, updateTheCountryData);
  ...
  }, [triggerRef, onIntersect, updateTheCountryData]);
